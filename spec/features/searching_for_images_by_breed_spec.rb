...
feature 'Search by breed' do
  scenario 'A user can search for cat descriptions by breed' do
    ...
    stub_request(:get, 'https://api.thecatapi.com/v1/breeds/beng').with(headers: { 'Accept' => 'application/json', 'Connection' => 'close', 'Host' => 'api.thecatapi.com', 'User-Agent' => 'http.rb/5.0.1' }).to_return(
      status: 200, body: search_by_breed_api_response_json, headers: {}
    )
